...
public class ResultUtils {
    ...
    public static <T> SingleResponse of(Boolean condition, String errMsg, ShowType showType) {
        if (condition) {
            return SingleResponse.buildSuccess();
        }
        return fail("400", errMsg, showType);
    }
    ...
    public static <T> SingleResponse of(Boolean condition, T success, String errMsg, ShowType showType) {
        if (condition) {
            return SingleResponse.of(success);
        }
        return fail("400", errMsg, showType);
